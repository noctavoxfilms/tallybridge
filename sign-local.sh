...
#
# Output: dist/TallyBridge-X.Y.Z-{x64,arm64}.dmg — signed, notarized,
# stapled, and with fresh auto-update metadata.
...
# Stapling changes the DMG bytes. Rebuild blockmaps and latest-mac.yml now,
# rather than publishing the pre-staple hashes generated by electron-builder.
echo ""
echo "▸ Refreshing auto-update metadata after stapling..."
node scripts/finalize-mac-release.js
